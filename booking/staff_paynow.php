					...
					<div class="form-group">
						<div id="payment-detail">
							...
							<div id="payment-row">
								...
								<p><span class="text-danger">Notice: </span>You payment will be verified within 24hours</p>
						...
						<form method="post" action="./staff_paynow.php" enctype="multipart/form-data">						
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<div class="input-group mb-0">
										<a class="btn btn-outline-primary btn-lg btn-block" href="./staff_managed.php">Don't Pay Now</a>
									</div>
								</div>
							</div>
						</form>
