				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<form method="post" action="./student_booking.php" enctype="multipart/form-data">
							...
							<?php if($_SESSION['depart_checkin'] == "Checked In" ): ?>
								<?php echo "You have check in Going"; ?>
							<?php endif ?>

							<?php if($_SESSION['arrive_checkin'] == "Checked In" ): ?>
								<?php echo array_push($errors, "You have check in Return"); ?>
							<?php endif ?>
