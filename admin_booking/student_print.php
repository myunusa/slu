				...
				<div class="pb-20">
					<div class="invoice-wrap ">
						<div class="invoice-box">
							...
							<div class="row pb-30">
								<div class="col-md-6">
									<img src="../vendors/images/profile/student/<?php echo $_SESSION['student_image']; ?>" style="width:130px; 
							...
							<div class="invoice-desc pb-30">
								...
								<a class="btn btn-danger d-print-none" href="./student_managed.php" role="button">Cancel</a>
