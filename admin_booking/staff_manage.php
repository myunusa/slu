...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Staff Bookings|Buk Bus Reservation</title>
	<!-- Site favicon -->
				...
				<ul style="margin-top:20px"id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<li><a href="javascript:;" class="active"> Manage Staff Booking</a></li>
						</ul>
					</li>
					<li>
				...
				<div class="card-box mb-30">
					...
					<div class="pb-20">
						...
						<table class="table hover data-table-export nowrap">
							...
							<tbody>
							  <?php foreach($fetch_staff as $staff):
							   $unused =($unused +1);
							   $booking_id= $staff['booking_id'];
							   $depart_from= $staff['depart_from'];
							   $arrive_to= $staff['arrive_to'];
							   $depart_date= $staff['depart_date'];
							   $arrive_date= $staff['arrive_date'];
							   $No_of_students= $staff['No_of_students'];
							   $payment_status= $staff['payment_status'];
							   $amount= $staff['amount'];
								echo '
								<tr>
								<td> '.$unused.' </td>
								...
								<td class="text-capitalize"> '.$No_of_students.'</td>
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											<a class="dropdown-item" href="../php_admin_booking/view.php?staff_booking='.$booking_id.'"><i class="dw dw-edit2"></i> More Details</a>
											<a class="dropdown-item" href="../php_admin/delete_info.php?staff_booking='.$booking_id.'"><i class="dw dw-delete-3"></i> Delete</a>
										</div>
									</div>
								</td>
								<td class="text-capitalize"> NGN '.$amount.'</td>
							</tr>';
							?>
							<?php endforeach; ?>
							</tbody>
				...
				<div class="card-box mb-30">
					...
					<div class="pb-20">
						<table class="table hover data-table-export nowrap">
							...
							<tbody>
							  <?php foreach($fetch_staffs as $staff):
							   $used =($used +1);
							   $booking_id= $staff['booking_id'];
							   $depart_from= $staff['depart_from'];
							   $arrive_to= $staff['arrive_to'];
							   ...
							   $amount= $staff['amount'];
							   $payment_status= $staff['payment_status'];
							   $ticket_status= $staff['ticket_status'];
								echo '
								<tr>
								<td> '.$used.' </td>
								<td class="text-capitalize"> '.$booking_id.' </td>
								...
								<td class="text-capitalize"> NGN '.$amount.'</td>
								<td class="text-capitalize"> '.$ticket_status.'</td>
							</tr>';
							?>
							<?php endforeach; ?>
							</tbody>
