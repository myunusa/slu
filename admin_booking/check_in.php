...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Check In Booking|Buk Bus Reservation</title>
	...
	<div class="login-wrap d-flex align-items-center flex-wrap justify-content-center">
		...
		<div class="row align-items-center">
				<div class="text-center col-md-6 col-lg-7">
					<img src="../vendors/images/background/u.jpg" alt="">
				</div>
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div id="img">
							<img src="../vendors/images/background/buk-logo.png">
							</div>
						<div class="login-title">
							<h2 class="text-center text-primary">Booking Check In</h2>
						</div>
						<form method="post" action="./check_in.php" enctype="multipart/form-data">
							...
							<div id="form">
								<div class="input-group custom">
									<input type="text" class="form-control form-control-lg" name="booking_id" value="<?php echo $booking_id; ?>"placeholder="Booking Id">
									<div class="input-group-append custom">
										<span class="input-group-text"><i class="icon-copy fi-archive"></i></i></span>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
										<input class="btn btn-outline-primary btn-lg btn-block" type="submit" name="check_in" value="Check In">
									</div>
								</div>
							</div>
						</form>
