		...
		<div class="row align-items-center">
				<div class="text-center col-md-6 col-lg-7">
                  ...
                  <ul>
                    ...
                    <li><strong>No of students: </strong><?php echo $_SESSION['No_of_students']; ?></li>
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Make payment of <span class="text-danger">NGN <?php echo $_SESSION['amount']; ?></span></h2>
						</div>
						<form method="post" action="./Pay_now.php" enctype="multipart/form-data">
							<?php include('../errors.php'); ?>
							<div class="form-group row align-items-center">
								<div class="col-5">
									<div class="form-group">
									<a class="btn btn-primary btn-lg btn-block" href="./make_payment.php">Don't Pay</a>
									</div>
								</div>
								<div class="col-1">
								...
								<div class="col-6">
									<div class="form-group">
										<input class="btn btn-outline-primary btn-lg btn-block" type="submit" name="pay_now" value="Confirm Payment">
									</div>
								</div>
							</div>
						</form>
