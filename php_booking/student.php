<?php
  ...
  if (isset($_POST['student_booking'])) {
    ...
    if(count($errors) == 0){
      ...
      header('location: ../booking/student_payment.php');
    }
  }
  //  
  ...
  if (isset($_POST['update_booking'])) {
    ...
    if($_SESSION['depart_checkin'] == "Not checkin" ){
      $depart_seat= 1;
      $depart_date = $_POST['depart_date'];
      $depart_time = mysqli_real_escape_string($db, $_POST['depart_time']);
    }
    if($_SESSION['arrive_checkin'] == "Not checkin" ){
      $arrive_seat= 1;
      $arrive_date = $_POST['arrive_date'];
      $arrive_time = mysqli_real_escape_string($db, $_POST['arrive_time']);
    }
    ...
    elseif ( $depart_from == $arrive_to){array_push($errors,"You can't pick thesame route!");}
    elseif($_SESSION['depart_checkin'] == "Not checkin" ){
    ...
    if(count($errors) == 0){
      ...
      // $student_email= $_SESSION['student_email'];
        ...
        // You can lognin to your account to chick in your booking before 2 hours to the trip';
        // if(mail($receiver, $subject, $body, $sender)){
      if($_SESSION['depart_checkin'] == "Not checkin" && $_SESSION['arrive_checkin'] == "Not checkin"){
      ...
      elseif($_SESSION['arrive_checkin'] == "Not checkin"){
