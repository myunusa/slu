...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Signup|Buk Bus Reservation</title>
					...
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<form method="post" action="./signup_user.php" enctype="multipart/form-data">
							...
							<div id="form">
								...
								<div class="input-group custom">
									<input type="text" class="form-control form-control-lg" name="phone" value="<?php echo $phone; ?>"placeholder="Enter Phone Number:(+234)">
									<div class="input-group-append custom">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
										<input class="btn btn-primary btn-lg btn-block" type="submit" name="user_signup" value="Sign Up">
									</div>
									<div class="font-16 weight-600 pt-10 pb-10 text-center" data-color="#707373"></div>
									<div class="input-group mb-0">
										<a class="btn btn-outline-primary btn-lg btn-block" href="./user_signin.php">Already Sign Up?</a>
									</div>
								</div>
							</div>
						</form>
