...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Admin Signin|Buk Transport Bus</title>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="text-center col-md-6 col-lg-7">
					<img  src="../vendors/images/background/admin_log.png" alt="">
				</div>
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Adminstirator Sign In </h2>
						</div>
						<form method="post" action="../register/admin_signin.php" enctype="multipart/form-data">
						<?php if (isset($_SESSION['message'])) : ?>
							...
							<div class="row pb-30">
								<div class="col-6">
									<div class="forgot-password"><a href="./admin_forgot.php">Forgot Password</a></div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
											<input class="btn btn-primary btn-lg btn-block" name="signin" type="submit" value="Sign In">
									</div>
								</div>
							</div>
						</form>
