				...
				<div class="pb-20">
					<div class="invoice-wrap ">
						<div class="invoice-box">
							...
							<h4 class="text-center text-uppercase mb-30 weight-600"><?php echo $_SESSION['staff_id']; ?> DETAILS</h4>
							<div class="row pb-30">
								<div class="col-md-6">
									<ul>
										<li><img src="../vendors/images/profile/staff/<?php echo $_SESSION['staff_image'];?>" style="width:100px; height:100px; border-radius:70%;border: 3px solid #045caf; margin-bottom: 10px;" alt=""></li>
										<li>&emsp;</li>
										<h5 class="mb-15">Staff Id: </strong><?php echo $_SESSION['staff_id']; ?></h5>
										
										<li><strong>Name: </strong><?php echo $_SESSION['staff_fullname']; ?></br></li>
										<li>&emsp;</li>
										<li><strong>Department: </strong><?php echo $_SESSION['department']; ?></br></li>
										<li>&emsp;</li>
										<li><strong>Email: </strong><?php echo $_SESSION['staff_email']; ?></li>
										<li>&emsp;</li>
										<li><strong>Phone Number: </strong><?php echo $_SESSION['staff_phone']; ?></li>
										<li>&emsp;</li>
										<li><strong>E_Card: </strong><?php echo $_SESSION['staff_e_card']; ?></br></li>
										<li>&emsp;</li>
										<li><strong>Amount to Pay: </strong>NGN <?php echo $_SESSION['staff_e_unit']; ?>.00</br></li>
										<li>&emsp;</li>
										<li><strong>Verify Status: </strong><?php echo $_SESSION['staff_verify']; ?></br></li>
										<li>&emsp;</li>
										<li><strong>Password: </strong><?php echo $_SESSION['staff_password']; ?></li>
									</ul>
								</div>
							</div>
							<a class="btn btn-danger d-print-none" href="./staff_dashboard.php" role="button">Cancel</a>
