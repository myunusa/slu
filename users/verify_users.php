<?php 
  include('../php_users/verify_users.php');
?>
<!DOCTYPE html>
<html>
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Verify User|Buk Bus Reservation</title>
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">User Verification</h2>
						</div>
						<form method="post" action="./verify_users.php" enctype="multipart/form-data">
							...
							<?php endif ?>
							<div id="form">
								<div class="input-group custom align-items-center justify-content-center">
									<input type="text" name="token" class="form-control form-control-lg" value="<?php echo $token; ?>" placeholder="Enter verification code sent to your email">
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
										<input class="btn btn-primary btn-lg btn-block" type="submit" name="verify_users" value="Verify">
									</div>
								</div>
							</div>
						</form>
