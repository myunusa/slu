	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			...
			<div class="login-menu">
				<ul>
					<li>
						<a href="./staff_dashboard.php" class="dropdown-toggle no-arrow">
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="text-center col-md-6 col-lg-7">
					...
					<div id="payment-row">
						<h5><?php echo $_SESSION['staff_id']; ?> DETAILS</h5>
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<form method="post" action="./staff_update_info.php" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
										<input class="btn btn-outline-primary btn-lg btn-block" type="submit" name="staff_update" value="Submit">
									</div>
								</div>
							</div>
						</form>
