			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						...
						<?php if ($_SESSION['student_verify'] == "Verified"):?>
							<a class="dropdown-item" href="./student_update_info.php"><i class="dw dw-settings2"></i>Update Info.</a>
							<?php endif ?>
							<?php if ($_SESSION['student_verify'] == "Unverified"):?>
								<a class="dropdown-item" href="./student_update_email.php"><i class="dw dw-settings2"></i> Update Email</a>
							<?php endif ?>
							<a class="dropdown-item" href="./student_print_info.php"><i class="dw dw-print"></i>Print Info.</a>
	...
	<div class="left-side-bar">
		...
		<div class="sidebar-menu">
				<ul style="margin-top:10px"id="accordion-menu">
					...
					<?php if ($_SESSION['student_verify'] == "Verified"):?>
						<li>
							<a href="../booking/student_booking.php" class="dropdown-toggle no-arrow">
								<span class="micon dw dw-bus"></span><span class="mtext">New Booking</span>
							</a>
						</li>
						<li>
							<a href="../booking/student_manage.php" class="dropdown-toggle no-arrow">
				...
				<?php endif ?>
					...
					<div class="product-detail-wrap mb-30">
						<div class="row">
									...
									<div class="row">
										<?php if ($_SESSION['student_verify'] == "Verified"):?>
											<div class="col-md-12 col-sm-12">
												...
												<p>An Electronic Card is a virtual card that has 16 digital Number that you can use for your booking, your E-Card Number is: <strong><?php echo $_SESSION['student_e_card']; ?></strong></p>
											</div>
										<?php endif ?>
										<?php if ($_SESSION['student_verify'] == "Unverified"):?>
											<div class="col-md-12 col-sm-12">
											...
											<p>You cannot make new booking or manage booking with unvirify account, If your email <strong><?php echo $_SESSION['student_email']; ?></strong> is invalid click on Change Email.</p>
												<a href="./student_update_email.php" class="btn btn-outline-primary btn-block">Change Email</a>
										</div>
										<?php endif ?>
									</div>
								</div>
							...
							<div class="col-lg-6 col-md-12 col-sm-12">
								<div id="user-info">
									<h4><?php echo $_SESSION['regno']; ?> DETAILS</h4>
									<ul>
										<li><strong>Account Balance: NGN <?php echo $_SESSION['student_e_unit']; ?>.00</strong></li>
										<li><strong>E-card: </strong><?php echo $_SESSION['student_e_card']; ?></li>
									...
									<div class="row">
										<?php if ($_SESSION['student_verify'] == "Verified"):?>
											<div class="col-md-12 col-sm-12">
												...
												<p>You can make booking or manage booking with virify account, use <strong><?php echo $_SESSION['student_e_card']; ?></strong> as your E-Card Number to make your booking payment.</p>
												<div class="row">
													<div class="col-md-6 col-6">
														<a href="../booking/student_booking.php" class="btn btn-outline-primary btn-block">Book Now</a>
													</div>
													<div class="col-md-6 col-6">
														<a href="../booking/student_manage.php" class="btn btn-primary btn-block">Manage Booking</a>
													</div>
												</div>
											</div>
										<?php endif ?>
										<?php if ($_SESSION['student_verify'] == "Unverified"):?>
											<div class="col-md-12 col-sm-12">
												...
												<p>To verify your acount, Kindly sign into your email account and click on the verification link sent to <strong><?php echo $_SESSION['student_email']; ?></strong>.</p>
