				...
				<div class="pb-20">
					<div class="invoice-wrap ">
						<div class="invoice-box">
							...
							<div class="row pb-30">
								<div class="col-md-6">
									<ul>
										...
										<li>&emsp;</li>
										<li><strong>Amount Balance: </strong>NGN <?php echo $_SESSION['student_e_unit']; ?>.00</br></li>
										<li>&emsp;</li>
							...
							<a class="btn btn-danger d-print-none" href="./student_dashboard.php" role="button">Cancel</a>
