	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			...
			<div class="login-menu">
				<ul>
					<li>
						<a href="./signup_staff.php" class="dropdown-toggle no-arrow">
			...
			<div class="row align-items-center">
				<div class="text-center col-md-6 col-lg-7">
					...
					<div id="payment-row">
						...
						<ul>
						  <li><img src="../vendors/images/profile/staff/<?php echo $_SESSION['staff_image'];?>" style="width:90px; height:90px; border-radius:50%; border: 3px solid #045caf; margin-bottom: 10px;" alt=""></li>
						 <br> 
						  <li>&emsp;</li>
