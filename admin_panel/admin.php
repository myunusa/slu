...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Admins|Buk Bus Reservation</title>
	<!-- Site favicon -->
			...
			<div class="sidebar-menu">
				<ul style="margin-top:20px"id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="javascript:;" class="active">Admin</a></li>
					...
					<li class="dropdown">
						<a  class="dropdown-toggle">
							<span class="micon dw dw-user-1"></span><span class="mtext">Student Booking</span>
						</a>
						<ul class="submenu">
							<li><a href="../admin_booking/student_booking.php">New Booking</a></li>
							<li><a href="../admin_booking/student_manage.php">Manage Booking</a></li>
							<li><a href="../admin_booking/student_checkin.php">Check In</a></li>
						</ul>
					</li>
					<li>
				...
				<div class="card-box mb-30">
					...
					<div class="pb-20">
						...
						<table class="table hover data-table-export nowrap">
							...
							<tbody>
							  <?php foreach($fetch_admin as $admin):
								$sn =($sn +1);
								$id=$admin['id'];
								...
								<td class="text-capitalize"> '.$user_name.' </td>
								<td class="text-capitalize"> '.$email.' </td>
								<td class="text-center"> '.$password.' </td>
								<td> <img src="../vendors/images/profile/admin/'.$image.'" style="width:50px; height:50px"> </td>
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
										<a class="dropdown-item" href="../php_admin/view.php?admin='.$id.'"><i class="dw dw-edit2"></i> Edit</a>
										<a class="dropdown-item" href="../php_admin/print_info.php?print_admin='.$id.'"><i class="dw dw-print"></i> Print</a>
										<a class="dropdown-item" href="../php_admin/delete_info.php?delete_admin='.$id.'"><i class="dw dw-delete-3"></i> Delete</a>
										</div>
									</div>
								</td>
