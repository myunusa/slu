...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<!-- Unacknowledged Contact Us start -->
			<div class="min-height-200px">
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">LIST OF UNACKNOWLEDGED CONTACT USERS</h4>
					</div>
					<div class="pb-20">
						...
						<table class="table hover data-table-export nowrap">
							...
							<tbody>
							<!-- <a href="../php_contact_us/contact_control.php"></a> -->
							  <?php foreach($user as $user):
								$Unacknowledge_id =($Unacknowledge_id +1);
								$id=$user['id'];
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											<a class="dropdown-item" name="acknowledge" href="../php_admin/view.php?acknowledge='.$id.'"><i class="icon-copy ion-checkmark"></i> Acknowledge</a>
											<a class="dropdown-item" name="delete_contact" href="../php_admin/delete_info.php?delete_contact='.$id.'"><i class="dw dw-delete-3"></i> Delete</a>
										</div>
									</div>
								</td>
								<td> '.$message.' </td>
			...
			<!-- Acknowledged Contact Us start -->
			<div class="min-height-200px">
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">LIST OF ACKNOWLEDGED CONTACT USERS</h4>
					</div>
					<div class="pb-20">
						<table class="table hover data-table-export nowrap">
							<thead>
							...
							<tbody>
							  <?php foreach($users as $user):
								$Acknowledge_id =($Acknowledge_id +1);
								$id=$user['id'];
								$fullname=$user['fullname'];
								$phone=$user['phone'];
								$email=$user['email'];
								...
								$subject=$user['subject'];
								$message=$user['message'];
								$acknowledge=$user['acknowledge'];
								echo '
								<tr>
								<td> '.$Acknowledge_id.' </td>
								<td class="text-capitalize"> '.$fullname.' </td>
								<td class="text-capitalize"> '.$phone.' </td>
								<td class="text-capitalize"> '.$email.' </td>
								<td class="text-capitalize"> '.$subject.' </td>
