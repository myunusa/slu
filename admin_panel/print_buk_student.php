				...
				<div class="pb-20">
					<div class="invoice-wrap ">
						<div class="invoice-box">
							...
							<h4 class="text-center text-uppercase mb-30 weight-600"><?php echo $_SESSION['buk_regno']; ?> DETAILS</h4>
							<div class="row pb-30">
								<div class="col-md-6">
									<ul>
										<h6 class="mb-15">Registration Number: </strong><?php echo $_SESSION['buk_regno']; ?></h6>
										
										<li><strong>Name: </strong><?php echo $_SESSION['buk_student_fullname']; ?></br></li>
										<li>&emsp;</li>
										<li><strong>Jamb Number: </strong><?php echo $_SESSION['buk_jambno']; ?></li>
									</ul>
								</div>
							</div>
							<a class="btn btn-danger d-print-none" href="./buk_student.php" role="button">Cancel</a>
