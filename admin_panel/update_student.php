	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			...
			<div class="login-menu">
				<ul>
					<li>
						<a href="./signup_student.php" class="dropdown-toggle no-arrow">
			...
			<div class="row align-items-center">
				<div class="text-center col-md-6 col-lg-7">
					...
					<div id="payment-row">
						...
						<ul>
						  <li><img src="../vendors/images/profile/student/<?php echo $_SESSION['student_image'];?>" style="width:90px; height:90px; border-radius:50%; border: 3px solid #045caf; margin-bottom: 10px;" alt=""></li>
						 <br> 
						  <li>&emsp;</li>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
										<input class="btn btn-outline-primary btn-lg btn-block" type="submit" name="student" value="Submit">
									</div>
								</div>
							</div>
						</form>
