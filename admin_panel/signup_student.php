...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Student|Buk Bus Reservation</title>
	<!-- Site favicon -->
				...
				<ul style="margin-top:20px"id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<?php endif ?>
							<li><a href="javascript:;" class="active">Signup Student</a></li>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<div class="min-height-200px">
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">LIST OF SIGNUP STUDENTS</h4>
					</div>
					<div class="pb-20">
						...
						<table class="table hover data-table-export nowrap">
							...
							<tbody>
							<?php foreach($fetch_signup_student as $student):
								$sn =($sn +1);
								...
								<td class="text-capitalize"> '.$regno.' </td>
								<td class="text-capitalize"> '.$email.' </td>
								<td class="text-capitalize"> '.$verify.' </td>
								<td> <img src="../vendors/images/profile/student/'.$image.'" style="width:40px; height:40px"> </td>
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
										<a class="dropdown-item" href="../php_admin/view.php?student='.$regno.'"><i class="dw dw-edit2"></i> Edit</a>
										<a class="dropdown-item" href="../php_admin/print_info.php?print_student='.$regno.'"><i class="dw dw-print"></i> Print</a>
										<a class="dropdown-item" href="../php_admin/delete_info.php?delete_student='.$regno.'"><i class="dw dw-delete-3"></i> Delete</a>
										</div>
									</div>
								</td>
								<td class="text-capitalize"> '.$jambno.' </td>
