				...
				<div class="pb-20">
					<div class="invoice-wrap ">
						<div class="invoice-box">
							...
							<h4 class="text-center text-uppercase mb-30 weight-600"><?php echo $_SESSION['user_name']; ?> DETAILS</h4>
							<div class="row pb-30">
								<div class="col-md-6">
									<ul>
										<li><img src="../vendors/images/profile/admin/<?php echo $_SESSION['image'];?>" style="width:100px; height:100px; border-radius:70%;border: 3px solid #045caf; margin-bottom: 10px;" alt=""></li>
										<li>&emsp;</li>
										<h5 class="mb-15">Username: </strong><?php echo $_SESSION['user_name']; ?></h5>
										
										<li><strong>Name: </strong><?php echo $_SESSION['fullname']; ?></br></li>
										<li>&emsp;</li>
							...
							<a class="btn btn-danger d-print-none" href="./admin.php" role="button">Cancel</a>
