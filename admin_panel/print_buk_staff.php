				...
				<div class="pb-20">
					<div class="invoice-wrap ">
						<div class="invoice-box">
							...
							<h4 class="text-center text-uppercase mb-30 weight-600"><?php echo $_SESSION['buk_staff_id']; ?> DETAILS</h4>
							<div class="row pb-30">
								<div class="col-md-6">
									<ul>
										<h6 class="mb-15">Staff Id: </strong><?php echo $_SESSION['buk_staff_id']; ?></h6>
										
										<li><strong>Name: </strong><?php echo $_SESSION['buk_staff_fullname']; ?></br></li>
										<li>&emsp;</li>
										<li><strong>Department: </strong><?php echo $_SESSION['buk_department']; ?></li>
									</ul>
								</div>
							</div>
							<a class="btn btn-danger d-print-none" href="./buk_staff.php" role="button">Cancel</a>
