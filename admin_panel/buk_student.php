...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Buk Student|Buk Bus Reservation</title>
	<!-- Site favicon -->
				...
				<ul style="margin-top:20px"id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<?php endif ?>
							<li><a href="javascript:;" class="active">BUK Student</a></li>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<div class="min-height-200px">
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">LIST OF BUK STUDENTS</h4>
					</div>
					<div class="pb-20">
						...
						<table class="table hover data-table-export nowrap">
							...
							<tbody>
							  <?php foreach($fetch_buk_student as $buk_student):
								$sn =($sn +1);
								$id=$buk_student['id'];
								$fullname=$buk_student['fullname'];
								$regno=$buk_student['regno'];
								$jambno=$buk_student['jambno'];
								echo '
								<tr>
								<td> '.$sn.' </td>
								<td class="text-capitalize"> '.$fullname.' </td>
								<td class="text-uppercase"> '.$regno.' </td>
								<td class="text-uppercase"> '.$jambno.' </td>
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
										<a class="dropdown-item" href="../php_admin/print_info.php?print_buk_student='.$regno.'"><i class="dw dw-print"></i> Print</a>
										<a class="dropdown-item" href="../php_admin/delete_info.php?delete_buk_student='.$regno.'"><i class="dw dw-delete-3"></i> Delete</a>
										</div>
									</div>
								</td>
									</tr>';
